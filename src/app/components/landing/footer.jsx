...
const Footer = () => {
  return (
    <footer className="relative text-gray-800 pt-16 pb-8 px-6 sm:px-10 md:px-20 overflow-hidden">
...
<div className="absolute bottom-0 left-0 z-0 w-[1200px] h-[900px] overflow-hidden pointer-events-none">
  ...
  />
      ...
      <div className="relative z-20 flex flex-col md:flex-row md:justify-between items-center md:items-end gap-10 mb-10 text-center md:text-left">
        ...
        {/* Left Links */}
        <div className="flex md:flex-col gap-8 text-3xl sm:text-3xl font-medium text-gray-500 items-center md:items-start" style={{ fontFamily: 'Rofane' }}>
